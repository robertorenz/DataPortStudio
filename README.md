...
![Status](https://img.shields.io/badge/status-v1.0.14-blue) ![Platform](https://img.shields.io/badge/platform-Windows-informational) ![.NET](https://img.shields.io/badge/.NET-9.0-512BD4)
...
**Option 1 — Installer** (`DataPortStudio-1.0.14-Setup.exe`, ~84 MB)
